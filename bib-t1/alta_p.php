...
if ($id_persona === false) {
    ...
    if (strtolower($persona->rol) === "estudiante") {
        $objConn = new Conexion();
        $sql = "INSERT INTO estudiante (id_persona) VALUES ($id_persona)";
        if (!$objConn->enlace->query($sql)) {
            echo "Error al insertar estudiante: " . $objConn->enlace->error;
        }
    }
  }
