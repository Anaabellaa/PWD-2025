...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-12-2025 a las 08:08:29
...
(22, 'Ayuda', 'Como registrarse', 'Al entrar en la plataforma se va a ver en la parte superior, menú, una opción llamada Registro, la cual a presionarla se mostrara un formulario a llenar con datos correspondientes, al terminar de hacer eso solo confirmamos todo y listo.', '', 5, '', '', 1, '', '', '', 'encabezado2.jpg'),
(23, 'Ayuda', 'Como iniciar sesión ', 'Luego de registrarnos, debemos ir a la opción Login, la cual mostrara unos campos para rellenar con el usuario y contraseña correspondiente, y luego solo se deberá confirmar para iniciar en la pagina como un usuario.', '', 5, '', '', 1, '', '', '', 'encabezado3.jpg'),
(24, 'Ayuda', 'Como buscar los libros', 'Como primera parte luego de iniciar sesión, para buscar los libros deseados se tendrá que ir a la opción Libros que se encuentra en el menú, luego se mostrara un buscador donde al ingresar el titulo o autor del libro que desee, se mostrará a simple vista.', '', 5, '', '', 1, '', '		   ', '		   ', 'encabezado0.jpg');
...
(156, 'Anabella', 'Bejarano', 'Femenino', '12131454', 'Mecatronica', 'bejaranoanabella03@gmail.com', 'lm', '1234', 'Estudiante');
...
CREATE TABLE `libros_d` (
  ...
  `formato` enum('impreso','digital') NOT NULL DEFAULT 'impreso'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `libros_d` (`id_libro`, `Autor`, `Titulo`, `edicion`, `año`, `origen`, `Area`, `Materia`, `Comentario`, `Archivo`, `tipo`, `estado`, `formato`) VALUES
(3, 'Hermann Hesse', 'Demian', 'Papel', '1944', 'inglaterra', '', '', '', 'demian.pdf', '', 'disponible', 'impreso'),
(4, 'Hermann Hesse', 'Lobo Estepario', 'Papel', '1943', 'Ingles', '', '', '', 'Hermann Hesse - El lobo estepario.pdf', '', 'disponible', 'impreso'),
(6, 'Luis Alberto Spinetta', 'Guitarra Negra', 'Papel', '1943', 'Frances', '', '', '', 'Spinetta.pdf', '', 'disponible', 'impreso'),
(7, 'Arthur Conan Doyle', 'El Mundo Perdido.pdf', '', '', '', '', '', '', 'Arthur Conan Doyle - El Mundo Perdido.pdf', 'Libro', 'disponible', 'impreso'),
(9, 'ALdous Huxley', 'Island', '', '', 'Inglés', '', '', '', 'Island.pdf', 'Libro', 'disponible', 'impreso'),
(10, 'Karel Capek', 'La Guerra de las salamandras', '', '', '', '', '', '', 'Capek, Karel-La Guerra De Las Salamandras.pdf', 'Libro', 'disponible', 'impreso'),
(11, 'Aldous Huxley', 'Contrapunto', '', '', '', '', '', '', 'contrapunto.pdf', 'Libro', 'disponible', 'impreso'),
(12, 'Lem Stanislaw', 'El Invencible', '', '', '', '', '', '', 'Lem, Stanislaw - El Invencible.pdf', 'Libro', 'disponible', 'impreso'),
(13, 'Huxley Aldous', 'Las puertas de la percepcion', '', '', '', '', '', '', 'Huxley, Aldous-Las puertas de la percepcion.pdf', 'Libro', 'disponible', 'impreso'),
(15, 'php.net', 'PHP orientado a objetos', 'documento ms word', '2016', 'Español', 'Informatica', 'programacion', '', 'php_poo.docx', 'Otros', 'disponible', 'impreso'),
(16, 'Bach  Richard', 'Juan Salvador Gaviota', '', '', 'Español', 'Literatura', '', '', 'Bach, Richard - Juan Salvador Gaviota.pdf', 'Libro', 'disponible', 'impreso'),
(17, 'Greene Graham', 'Nuestro Hombre en La Habana', '', '', 'Español', '', '', '', 'Greene, Graham-Nuestro Hombre en La Habana.pdf', 'Libro', 'disponible', 'impreso'),
(20, 'Frank, Ana', 'El diario de Ana Frank', '', '', '', '', '', '', 'Frank, Ana - Diario.pdf', 'Libro', 'disponible', 'impreso'),
(21, 'Aldous Huxley', 'El joven Arquímedes', '', '', 'Español', 'Cultura', 'Literatura', '', 'el_joven_arquímedes.pdf', 'Libro', 'disponible', 'impreso'),
(22, 'George Orwell', 'El camino de Wigan Pier', '', '', 'Español', '', '', '', 'el_camino_de_wigan_pier.pdf', 'Libro', 'disponible', 'impreso'),
(23, 'CakePHP Team', 'CakePHP Cookbook', '', '', 'Español', '', '', '', 'CakePHPCookbook.pdf', 'Libro', 'disponible', 'impreso'),
(24, 'José Manuel Ruiz Gutiérrez ', 'Manual de Programacion Arduino', '', '', 'Español', '', '', '', 'Manual+Programacion+Arduino.pdf', 'Libro', 'disponible', 'impreso'),
(27, 'Gogol Nikolai', 'Capote', '', '', 'Castellano', '', '', '', 'Gogol-N-EL_Capote.pdf', 'Libro', 'disponible', 'impreso'),
(28, 'FIODOR DOSTOIEWSKI', 'Crimen y Castigo', '', '', 'español', 'sociales', 'Literatura', '', 'crimencastigo.pdf', 'Libro', 'disponible', 'impreso'),
(29, 'Albert Einstein', 'Mis Creencias', '', '', '', '', '', '', 'Albert Einstein - Mis Creencias .pdf', 'Libro', 'disponible', 'impreso'),
(30, 'UMBERTO ECO ', 'EL PENDULO DE FOUCAULT', '', '', '', '', '', '', 'Eco - El Péndulo de Foucault.pdf', 'Libro', 'disponible', 'impreso'),
(31, 'Garcia Marquez, Gabrie', 'De Viaje Por Los Paises Socialistas', '', '', '', '', '', '', 'Garcia Marquez, Gabriel - De Viaje Por Los Paises Socialistas.pdf', 'Libro', 'disponible', 'impreso'),
(32, 'Garcia Marquez, Gabrie', 'El Rastro de tu Sangre en la Nieve', '', '', '', '', '', '', 'Garcia Marquez, Gabriel - El Rastro de tu Sangre en la Nieve.pdf', 'Libro', 'disponible', 'impreso'),
(33, 'INGENIEROS JOSE', 'Las Fuerzas Morales', '', '', '', '', '', '', 'INGENIEROS JOSE - Las Fuerzas Morales.pdf', 'Libro', 'disponible', 'impreso'),
(34, 'Manfredi, Valerio Massimo', 'El Tirano', '', '', '', '', '', '', 'Manfredi, Valerio Massimo - El Tirano.pdf', 'Libro', 'disponible', 'impreso'),
(35, 'Ernest Hemingway', 'Aguas primaverales', '', '', '', '', '', '', 'aguas_primaverales.pdf', 'Libro', 'disponible', 'impreso'),
(36, 'Benito Pérez Galdós', 'el caballero encantado', '', '', '', '', '', '', 'el_caballero_encantado.pdf', 'Libro', 'disponible', 'impreso'),
(37, 'Oscar Wilde', 'el retrato de dorian gray', '', '', '', '', '', '', 'el_retrato_de_dorian_gray.pdf', 'Libro', 'disponible', 'impreso'),
(38, 'Wlliam Shakespeare', 'el sueño de una noche de verano', '', '', '', '', '', '', 'el_sueño_de_una_noche_de_verano.pdf', 'Libro', 'disponible', 'impreso'),
(39, 'George Orwell', 'La hija del clérigo', '', '', '', '', '', '', 'la_hija_del_clérigo.pdf', 'Libro', 'disponible', 'impreso'),
(40, 'Ernest Hemingway', 'Las nieves del Kilimanjaro', '', '', '', '', '', '', 'las_nieves_del_kilimanjaro.pdf', 'Libro', 'disponible', 'impreso'),
(41, 'Aldous Huxley', 'Música en la noche', '', '', '', '', '', '', 'música_en_la_noche.pdf', 'Libro', 'disponible', 'impreso'),
(42, 'Ernest Hemingway', 'Tener y No Tener', '', '', '', '', '', '', 'tener_y_no_tener.pdf', 'Libro', 'disponible', 'impreso'),
(43, 'H. G. Wells', 'Tono – Bungay', '', '', '', '', '', '', 'tono-bungay.pdf', 'Libro', 'disponible', 'impreso'),
(44, 'Ernest Hemingway', 'Tener y No Tener', '', '', '', '', '', '', 'tener_y_no_tener.pdf', 'Libro', 'disponible', 'impreso'),
(45, 'William Shakespeare', 'Romeo y Julieta - 01', '', '', 'Español', '', '', '', 'romeoyjulieta_01_shakespeare_64kb.mp3', 'Audio', 'disponible', 'impreso'),
(46, 'Miguel de Cervantes Saavedra', 'Don Quijote de la Mancha – Audiolibro', '', '', 'Español', '', '', '', 'donquijote.mp4', 'Video', 'disponible', 'impreso');
...
(156, 'Anabella', 'Bejarano', 'Femenino', '48029937', 'Mecatronica', '1132394478', 'bejaranoanabella03@gmail.com', 'lm', '81dc9bdb52d04dc20036dbd8313ed055', 'Estudiante'),
(157, 'Sharon', 'Pignetto', 'Femenino', '37958675', 'Multimedia', '', 'pignettosharon@gmail.com', 'sp', '81dc9bdb52d04dc20036dbd8313ed055', 'Estudiante'),
(158, 'Kevin', 'Avila', 'Masculino', '36847564', 'Electronica', '1122875364', 'kevinavila@gmail.com', 'ka', '81dc9bdb52d04dc20036dbd8313ed055', 'Estudiante');
...
(1, 7, 156, '2025-12-17', '2025-12-18', 'activo'),
(2, 21, 156, '2025-12-15', '2025-12-17', 'activo'),
(3, 6, 158, '2025-12-17', '2025-12-18', 'activo');
...
INSERT INTO `usuarios_online` (`id`, `last_ping`, `username`, `rol`) VALUES
(150, '2025-12-18 02:53:46', 'cm', 'administrador');
...
--
ALTER TABLE `prestamos`
  ADD CONSTRAINT `fk_prestamo_libro` FOREIGN KEY (`id_libro`) REFERENCES `libros_d` (`id_libro`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_prestamo_persona` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id`) ON UPDATE CASCADE;
COMMIT;
